...
strKeyPath = "Software\Microsoft\Windows\CurrentVersion\WINEVT\Channels\Microsoft-Windows-PrintService/Admin"
...
WScript.ECHO "Script complete. print log is now disabled"